    ...
    <section class="section is-main-section column is-half">
      <card-component title="2026.04.22">
        <div class="item mb-4">
          ...
          <div class="text mt-2">
            Correcció d'errors en esborrar hores planificades al gantt de
            projecte.
          </div>
        </div>
      </card-component>
      <card-component title="2026.04.15">
        <div class="item mb-4">
          ...
          <div class="text mt-2">
            Millores en la gestió i visualització de projectes mare, amb una
            nova vista de llistat i una nova vista de fitxa de projecte mare.
          </div>
        </div>
      </card-component>
      ...
      <card-component title="2025.02.09">
        <div class="item mb-4">
          <span class="tag is-warning">Millores</span>
          <div class="text mt-2">
            Millores de rendiment a l'actualitzar projectes i factures.
          </div>
        </div>
      </card-component>
      ...
      <card-component title="2024.03.21">
        <div class="item mb-4">
          <span class="tag is-primary">Novetats</span>
          <div class="text mt-2">
            Enviament de factures de clientes per correu electrònic.
          </div>
          <div class="text mt-2">
            Funcionalitat per saldar l'IVA amb prorrata a
      ...
      <card-component title="2024.01.10">
        <div class="item mb-4">
          <span class="tag is-primary">Novetats</span>
          <div class="text mt-2">
            Nova secció de registre de canvis (aquesta).
          </div>
          <div class="text mt-2">
            El mòdul de
            <router-link to="/justifications">justificacions</router-link> es
            pot consultar també en funció de les hores previstes, a més a més de
            les reals.
          </div>
        </div>
        ...
        <div class="item">
          ...
          <div class="text mt-2">
            A les
            <router-link to="/working-day">jornades de persones</router-link>,
            s'agafa l'últim dia del més com a data final en nous períodes.
          </div>
        </div>
      </card-component>
    </section>
