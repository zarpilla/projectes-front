<template>
  <div v-if="!isLoading">
    ...
    <section class="section is-main-section">
      ...
      <card-component title="Incidències">
        <incidences-pivot :year="filters.year" :month="filters.month" v-if="!isLoading" />
      </card-component>
    </section>
  </div>
</template>
...
export default {
  ...
  computed: {
    titleStack() {
      return ["Incidències", "Taula dinàmica"];
    }
  },
  async mounted() {
    this.isLoading = true;
